  ...
  if (isset($_POST['btnLogin'])) {
  	...
  	if ($data = mysqli_fetch_assoc($checkUsername)) {
  		if (password_verify($password, $data['password'])) {
			...
			setAlert("Password Incorrect!", "Please, check your password again!", "error");
  ...
  <style>
	* {
  	...
  	body {
	    ...
	    background-image: url(assets/img/img_properties/bglogin.png);
	}
...
<body>
	...
	<footer style="position: absolute; bottom: 0; width: 100%; text-align: center;">
		<div style="background-color: transparent;" class="container-fluid mt-5">
			<div class="row justify-content-center">
				<div class="col-lg text-center text-white pt-6 pb-2">
					<p>&copy; Copyright 2024. By Shinta Wahyu Hapsari. All Right Reserved.</p>
				</div>
			</div>
		</div>
	</footer>
